...
if __name__ == '__main__':
    ...
    parser.add_argument('--path',   required=True, type=str, help='Path to the dataset folder' ) #/work3/s194572/SoccerData/mvfouls
    ...
    parser.add_argument("--path_to_model_weights", required=False, type=str, default="", help="Path to the model weights") #weights/14_model.pth.tar
